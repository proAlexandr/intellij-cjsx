...
public class CjsxElementType extends IElementType {
    ...
    public static final IElementType SPREAD_ATTRIBUTE = new CjsxElementType("SpreadAttribute");
    public static final IElementType NAME_VALUE_ATTRIBUTE = new CjsxElementType("NameValueAttribute");
