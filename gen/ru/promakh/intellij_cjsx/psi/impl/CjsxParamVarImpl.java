...
public class CjsxParamVarImpl extends ASTWrapperPsiElement implements CjsxParamVar {

  public CjsxParamVarImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CjsxVisitor) ((CjsxVisitor)visitor).visitParamVar(this);
