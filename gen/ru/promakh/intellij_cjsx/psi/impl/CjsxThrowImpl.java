...
public class CjsxThrowImpl extends ASTWrapperPsiElement implements CjsxThrow {

  public CjsxThrowImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CjsxVisitor) ((CjsxVisitor)visitor).visitThrow(this);
