...
public class CjsxForImpl extends ASTWrapperPsiElement implements CjsxFor {

  public CjsxForImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CjsxVisitor) ((CjsxVisitor)visitor).visitFor(this);
  ...
  @Override
  @NotNull
  public CjsxForBody getForBody() {
    return findNotNullChildByClass(CjsxForBody.class);
  }
