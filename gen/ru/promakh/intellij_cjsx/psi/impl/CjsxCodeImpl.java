...
public class CjsxCodeImpl extends ASTWrapperPsiElement implements CjsxCode {

  public CjsxCodeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CjsxVisitor) ((CjsxVisitor)visitor).visitCode(this);
  ...
  @Override
  @NotNull
  public CjsxFuncGlyph getFuncGlyph() {
    return findNotNullChildByClass(CjsxFuncGlyph.class);
  }
