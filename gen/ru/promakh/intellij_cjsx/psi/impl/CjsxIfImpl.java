...
public class CjsxIfImpl extends ASTWrapperPsiElement implements CjsxIf {

  public CjsxIfImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CjsxVisitor) ((CjsxVisitor)visitor).visitIf(this);
