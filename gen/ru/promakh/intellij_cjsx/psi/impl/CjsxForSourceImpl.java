...
public class CjsxForSourceImpl extends ASTWrapperPsiElement implements CjsxForSource {

  public CjsxForSourceImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CjsxVisitor) ((CjsxVisitor)visitor).visitForSource(this);
