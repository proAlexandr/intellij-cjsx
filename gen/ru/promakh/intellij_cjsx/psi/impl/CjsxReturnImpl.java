...
public class CjsxReturnImpl extends ASTWrapperPsiElement implements CjsxReturn {

  public CjsxReturnImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CjsxVisitor) ((CjsxVisitor)visitor).visitReturn(this);
