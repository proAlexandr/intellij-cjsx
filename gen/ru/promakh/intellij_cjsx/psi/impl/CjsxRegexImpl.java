...
public class CjsxRegexImpl extends ASTWrapperPsiElement implements CjsxRegex {

  public CjsxRegexImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CjsxVisitor) ((CjsxVisitor)visitor).visitRegex(this);
