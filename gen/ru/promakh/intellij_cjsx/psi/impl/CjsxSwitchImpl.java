...
public class CjsxSwitchImpl extends ASTWrapperPsiElement implements CjsxSwitch {

  public CjsxSwitchImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CjsxVisitor) ((CjsxVisitor)visitor).visitSwitch(this);
  ...
  public CjsxWhens getWhens() {
    return findNotNullChildByClass(CjsxWhens.class);
  }
