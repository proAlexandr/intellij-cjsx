...
public class CjsxArrayImpl extends ASTWrapperPsiElement implements CjsxArray {

  public CjsxArrayImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CjsxVisitor) ((CjsxVisitor)visitor).visitArray(this);
