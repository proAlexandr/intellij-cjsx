...
public class CjsxStringImpl extends ASTWrapperPsiElement implements CjsxString {

  public CjsxStringImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CjsxVisitor) ((CjsxVisitor)visitor).visitString(this);
